...
if __name__ == '__main__':
    ...
    logging.info("Generating phonemes...")
    if subprocess.call(['phonetisaurus-apply --model ' + model + ' --word_list ' + input + ' > missing-phonemes'], shell=True):
        sys.exit('error in subprocess')
    logging.info("Copy generated phonemes to given dictionary...")
